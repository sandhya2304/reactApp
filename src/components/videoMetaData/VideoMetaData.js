...
const VideoMetaData = ({video:{snippet,statistics},videoId}) => {
    ...
    const {
     ...
     const subscriptionStatus = 
          useSelector(state => state.channelDetails.subscriptionStatus);    
    ...
    return (
        ...
        <div className="videoMetaData py-2">
           <div className="videoMetaData__top">
             ...
             <div className="videoMetaData__channel d-flex
                  justify-content-between align-items-center my-2 py-3">
